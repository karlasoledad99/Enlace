  ...
  head: () => ({
    meta: [
      ...
      { title: "Enlace Empresarial — Consejo estratégico premium" },
      {
        name: "description",
        content:
          "Impulsamos el crecimiento de su empresa con asesoría financiera, optimización operativa y transformación digital. Contáctenos por WhatsApp.",
      },
      { name: "author", content: "Enlace Empresarial" },
      {
        property: "og:title",
      ...
      { name: "twitter:site", content: "@EnlaceEmpresarial" },
    ],
    links: [
      {
        rel: "stylesheet",
